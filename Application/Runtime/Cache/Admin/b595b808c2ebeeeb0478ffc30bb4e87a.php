...
<!-- END SIDEBAR -->
    ...
    <div class="span12">
        ...
        <!-- END PAGE TITLE & BREADCRU/Application/Admin/View/-->
            ...
            <script src="/Application/Admin/View/js/morris.js"></script>
            <script src="http://cdnjs.cloudflare.com/ajax/libs/prettify/r224/prettify.min.js"></script>
            <script src="/Application/Admin/View/js/example.js"></script>
            <link rel="stylesheet" href="http://cdnjs.cloudflare.com/ajax/libs/prettify/r224/prettify.min.css">
            <link rel="stylesheet" href="/Application/Admin/View/css/morris.css">
            ...
            <div id="main">
                <center>
                    ...
                    <pre id="code" class="prettyprint linenums" style="display: none;">
                        ...
                        var day_data = [
                            <?php if(is_array($visitArr)): $i = 0; $__LIST__ = $visitArr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>{ "period": "<?php echo (date('Y-m-d',$v['vtime'])); ?>", "licensed": <?php echo ($v['num']); ?>},<?php endforeach; endif; else: echo "" ;endif; ?>
                            ];
                        Morris.Line({
                          element: 'graph',
                          data: day_data,
