...
<!-- END SIDEBAR -->
    ...
    <div class="page-content">
        ...
        <div class="container-fluid">
            ...
            <script charset="utf-8" src="/kindeditor/lang/zh_cn.js"></script>
                ...
                <style>
                    .ke-container{width: 500px !important;}
                </style>
    ...
    <div class="span12">
        ...
        <!-- END PAGE TITLE & BREADCRU/Application/Admin/View/-->
            ...
            <div id="main">
                <h3>更新新闻</h3>
                <form method="post" action=<?php echo U('blogs/updateTodo',"bid=".$resone['bid']);?> enctype="multipart/form-data">
                    新闻标题: <input type="text" name="title" style="width:430px" value="<?php echo ($resone['title']); ?>"/><br />
                    内　　容: <textarea  name="contents" id="editor_id" /><?php echo ($resone['contents']); ?></textarea><br />
                    新闻标题: <input type="file" name="blogimage"/><a href="<?php echo ($resone['blogimage']); ?>">图片已存在，重新上传会覆盖</a><br />
                    <br><br>
                    <input type="hidden" name="bid" value="<?php echo ($resone['bid']); ?>">
                    <input type="submit" value="更新新闻" class="btn">
                </form>
            </div>
        </div>
