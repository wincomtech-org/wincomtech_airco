<?php if (!defined('THINK_PATH')) exit();?>
    ...
    <div class="content">
        ...
        <form class="form-vertical login-form" action="<?php echo U('users/loginTodo');?>" method="post" enctype="multipart/form-data">

            <h3 class="form-title">欢迎访问环球空调后台</h3>
            ...
            <div class="form-actions">
                ...
                <label class="checkbox" style="margin-left: 21px;">
                    ...
                    <input type="checkbox" name="remember" value="1"/>记住登录信息
            ...
            <div class="forget-password">
                ...
                <p>
                    ...
                    不要担心, 点击 <a href="<?php echo U('users/forgotpassword');?>" class="" id="forget-password">这里</a>
            ...
            <div class="create-account">
                ...
                <p>
                    ...
                    <a href=<?php echo U("users/reg");?> id="register-btn" class="">点击注册</a>
