...
<div class="page_contain">
    ...
    <div class="w_contain m_page">
        ...
        <div class="bread_crumbs">
            <span>当前位置：<a href="<?php echo U('index/index');?>">首页</a>><a href="<?php echo U('blogs/index');?>">新闻资讯</a></span>
        </div>
        <!-- page title -->
        <h2 class="page_title"><img src="/Application/Home/View/image/column3.png" alt="" title=""></h2>
        <!-- page main content -->
        <div class="page_news clear">
            <ul>
                <?php if(is_array($Blogsarr)): $i = 0; $__LIST__ = $Blogsarr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                        <img src="/<?php echo ($vo['blogimage']); ?>" width="180px" height="140px" alt="" title="">
                        <a href="<?php echo U('blogs/views','bid='.$vo['bid']);?>">
                            <span><?php echo ($vo['title']); ?></span>
                            <span><?php echo truncate_zh(htmlspecialchars_decode($vo['contents']),160,"...");?></span>
                        </a>
