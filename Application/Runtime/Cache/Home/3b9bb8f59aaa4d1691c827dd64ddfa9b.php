...
<div class="page_contain">
    ...
    <div class="w_contain m_page">
        ...
        <div class="bread_crumbs">
            <span>当前位置：<a href="<?php echo U('index/index');?>">首页</a>><a href="<?php echo U('about/index');?>">关于环球</a></span>
        </div>
        <!-- page title -->
        <h2 class="page_title"><img src="/Application/Home/View/image/column2.png" alt="" title=""></h2>
        <!-- page main content -->
        <div class="page_about">
            <h3>品牌故事</h3>
            <?php echo (htmlspecialchars_decode($Aboutarr[0]['story'])); ?>
            <h3>我们的理念</h3>
            <?php echo (htmlspecialchars_decode($Aboutarr[0]['philosophy'])); ?>
            <h3>发展历程</h3>
            <div class="development">
                <?php if(is_array($Journeytarr)): $i = 0; $__LIST__ = $Journeytarr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><p><span><?php echo ($v['contents']); ?></span></p><?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
        </div>
    </div>
</div>
