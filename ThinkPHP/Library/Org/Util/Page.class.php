...
class Page{
    ...
    private $config  = array(
        'header' => '<li><a href="javascript:void(0);">%TOTAL_ROW% 条记录</a></li>',
        'prev'   => '<<',
        'next'   => '>>',
        'first'  => '1...',
        'last'   => '...%TOTAL_PAGE%',
        'theme'  => '%HEADER% %FIRST% %UP_PAGE% %LINK_PAGE% %DOWN_PAGE% %END% <li><a href="javascript:void(0);">%NOW_PAGE%/%TOTAL_PAGE%页</a></li>',
    );
