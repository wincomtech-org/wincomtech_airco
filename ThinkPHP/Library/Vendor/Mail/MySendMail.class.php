...
////$mail->setReceiver("522845646@qq.com");
////$mail->setReceiver("627286509@qq.com");
////$mail->setReceiver("571966926@qq.com");
//$mail->setReceiver("790934443@qq.com");
//$mail->setMailInfo("星光装饰网新密码重置", "尊敬 喜洋洋 会员您好,您的新密码为: 123123 ,请妥善保管好你的新密码,请勿告诉你的团伙!");
//$mail->sendMail();
//die('Mail OK!');
//
////如果报 Fatal error: Call to undefined function socket_write()
////C:\wamp\bin\php\php5.2.6\php.ini
////php_sockets.dll前面的注释符号”;”
?>
